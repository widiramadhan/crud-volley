...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    View dialogView;
    EditText txt_id, txt_nama, txt_telp;
    String id, nama, telp;
    ...
    private void DialogForm(String idx, String namax, String telpx, String button) {
        dialog = new AlertDialog.Builder(MainActivity.this);
        ...
        txt_telp  = (EditText) dialogView.findViewById(R.id.txt_telp);

        if (!idx.isEmpty()){
            txt_id.setText(idx);
            txt_nama.setText(namax);
            txt_telp.setText(telpx);
        } else {
            kosong();
        }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        String telpx  = jObj.getString(TAG_TELP);

                        DialogForm(idx, namax, telpx, "UPDATE");
